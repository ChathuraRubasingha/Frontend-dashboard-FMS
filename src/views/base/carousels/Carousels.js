...
import AngularImg from 'src/assets/images/vehicle1.png'
import ReactImg from 'src/assets/images/vehicle2.png'
import VueImg from 'src/assets/images/vehicle3.png'
...
const Carousels = () => {
  return (
    <div className="h-25">
      <CCarousel controls transition="crossfade h-25">
        <CCarouselItem>
